          ...
          return 'auto' === c
            ...
            ? c.map(function (t) {
                return (function t(e, n, i) {
                  ...
                  if (Array.isArray(e))
                    return Object.assign(f(n, e[0], i), { title: e[1] })
                  var a = e.children || []
            ...
            [
              ...
              function (t, r) {
                ...
                for (var _ = 0, x = 0, C = []; x < f.length; ) {
                  ...
                  if (
                    null === y ||
                    ($ = d(l(b.lastIndex + (p ? x : 0)), f.length)) === _
                  )
                    x = u(f, x, v)
                  else {
    ...
    304: function (t, e, n) {
      ...
      if (
        ...
        for (
          ...
          y(L[w++])
        ;(b.constructor = $), ($.prototype = b), p(r, 'RegExp', $)
      }
      g('RegExp')
    },
    305: function (t, e, n) {
        ...
        i(
          ...
          function () {
            ...
            return (
              ...
              '/' +
              String(
                void 0 === n && t instanceof RegExp && !('flags' in o)
                  ? s.call(t)
                  : n
              )
            )
